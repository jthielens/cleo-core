...
// AS4: com.cleo.lexicom.beans.as4bean.AS4Host / com.cleo.lexicom.beans.as4bean.AS4Mailbox
        map = new TreeMap<String,String>();
        map.put(".secure", "True");
        map.put(".standaloneaction", "False");
        map.put(".test", "False");
        ...
        map.put("Advanced.PGPEncryptionAlgorithm", "System Default");
        map.put("Advanced.PGPHashAlgorithm", "System Default");
        map.put("Advanced.SecurityTokenReferenceType", "Binary Security Token");
        map.put("Advanced.XMLEncryptionAlgorithm", "System Default");
        map.put("Advanced.ZipCompressionLevel", "System Default");
        map.put("Checkservername", "False");
        map.put("Connecttype", "0");
        ...
        map.put("Runnable", "True");
        map.put("Runninglocalrequired", "False");
        map.put("Secureportrequired", "True");
        map.put("Standardhtmldirectory", "True");
        map.put("Syntax[GET]", "POST /as4");
        map.put("Syntax[PUT]", "POST /as4\n[Content-Type=|application/octet-stream|application/xml|text/plain|text/xml|]");
        map.put("Uidswpd", "True");
        map.put("Usedefaultfilename", "False");
        hostmap.put(HostType.AS4, map);
        map = new TreeMap<String,String>();
        map.put(".localdecryptcert", "");
        map.put(".localencrcertalias", "");
        map.put(".localencrcertpassword", "");
        ...
        map.put(".uselocalsamecerts", "True");
        map.put("Authtype", "0");
        map.put("Header[PUT]", "[Content-Type]=application/octet-stream");
        map.put("Notreadyreason", "PMode.Initiator.Party is required.");
        map.put("Overridelistenercerts", "False");
        map.put("Pmode_businessinfo_properties", "[]");
        map.put("Pmode_errorhandling_report_asresponse", "False");
        map.put("Pmode_errorhandling_report_deliveryfailuresnotifyproducer", "True");
        map.put("Pmode_errorhandling_report_missingreceiptnotifyproducer", "True");
        map.put("Pmode_errorhandling_report_processerrornotifyconsumer", "True");
        map.put("Pmode_errorhandling_report_processerrornotifyproducer", "True");
        map.put("Pmode_general_mep", "http://www.oasis-open.org/committees/ebxml-msg/oneWay");
        map.put("Pmode_general_mep_binding", "http://docs.oasis-open.org/ebxml-msg/ebms/v3.0/ns/core/200704/push");
        map.put("Pmode_payloadservice_compressiontype", "<None>");
        map.put("Pmode_protocol_soap_version", "SOAP 1.2");
        map.put("Pmode_receptionawareness", "False");
        map.put("Pmode_receptionawareness_duplicatedetection", "False");
        map.put("Pmode_receptionawareness_duplicatedetection_maxwindow", "7");
        map.put("Pmode_receptionawareness_retry", "False");
        map.put("Pmode_receptionawareness_retry_maxretries", "0");
        map.put("Pmode_receptionawareness_retry_period", "60");
        map.put("Pmode_security_pmodeauthorize", "False");
        map.put("Pmode_security_sendreceipt", "False");
        map.put("Pmode_security_sendreceipt_nonrepudiation", "False");
        map.put("Pmode_security_usernametoken_created", "True");
        map.put("Pmode_security_usernametoken_digest", "True");
        map.put("Pmode_security_usernametoken_nonce", "True");
        map.put("Pmode_security_wssversion", "1.1.1");
        map.put("Pmode_security_x509_encryption_encrypt", "False");
        map.put("Pmode_security_x509_sign", "False");
        map.put("Pmode_security_x509_sign_attachment", "False");
        map.put("Pmode_security_x509_sign_element_body", "False");
        map.put("Pmode_security_x509_sign_element_messaging", "False");
        map.put("Usepartnersamecerts", "False");
        mailboxmap.put(HostType.AS4, map);
...
// OFTP: com.cleo.lexicom.beans.oftpbean.OFTPHost / com.cleo.lexicom.beans.oftpbean.OFTPMailbox
        ...
        map.put(".localencrcertpassword", "vlenc:7a8f96e3-6d3e-4b78-9460-1b8752647b78:fb8558bfcc54e1b2a4541b2fd2bbb43f");
        map.put(".localencryptcert", "");
        map.put(".localpackaging", "None");
        map.put(".localsigncertalias", "SIGN105");
        map.put(".localsigncertpassword", "vlenc:7a8f96e3-6d3e-4b78-9460-1b8752647b78:4b1c4fdcdebe194292ef7602b565abf3");
        map.put(".partnerclientcertfile", "");
        map.put(".partnerdecryptcert", "");
        map.put(".partnerdecryptpassword", "");
        map.put(".partnerencrcertfile", "");
        ...
        map.put("Authenticationcertpassword", "vlenc:7a8f96e3-6d3e-4b78-9460-1b8752647b78:8c5eadc6d491b0689e356c0d0804347f");
        map.put("Ciphersuite", "0");
        map.put("Compress", "False");
        map.put("Eerpcertpassword", "vlenc:7a8f96e3-6d3e-4b78-9460-1b8752647b78:03ce510eaf4eabbd6e6e4c16b43cd660");
