...
if [ "$1" = "update" ]; then
    ...
    if [ "$cleohome" != "" ]; then
        ...
        unset DISPLAY
        classpath=$here/cleo-labs-api-shell-5.4.0.0-SNAPSHOT.jar:$here/cleo-labs-util-5.4.0.0-SNAPSHOT.jar:$cleohome/lib/\*:$cleohome/lib/help/\*:$cleohome/webserver/AjaxSwing/lib/ajaxswing.jar:$cleohome/lib/hibernate/\*:$cleohome/lib/secureshare/\*:$cleohome/lib/json/\*:$cleohome/lib/jersey/\*:$cleohome/lib/ext/\*:$cleohome/lib/uri/\*:$cleohome/lib/saml/\*
